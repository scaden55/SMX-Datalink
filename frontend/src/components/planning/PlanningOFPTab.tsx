  ...
  if (!ofp) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center gap-2 p-4">
        ...
        <p className="text-[12px] text-acars-muted">Generate an OFP to view it here</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-acars-border">
        <span className="text-[12px] text-acars-muted tabular-nums">
      ...
      <div className="flex-1 overflow-auto p-3">
        <pre className="text-[12px] tabular-nums text-acars-text whitespace-pre-wrap break-words leading-relaxed">
