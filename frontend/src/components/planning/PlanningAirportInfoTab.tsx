    ...
    <div className="p-3 space-y-3 overflow-auto">
      <div>
        <div className="flex items-center gap-2 mb-2">
          <span className="tabular-nums text-base font-bold text-acars-text">{airport.icao}</span>
          <span className="text-[12px] text-acars-muted">{airport.name}</span>
        </div>
        <div className="grid grid-cols-2 gap-y-2 gap-x-4">
          <div>
            <span className="planning-label">City</span>
            <span className="text-[12px] text-acars-text">{airport.city}, {airport.state}</span>
          </div>
          <div>
            <span className="planning-label">Country</span>
            <span className="text-[12px] text-acars-text">{airport.country}</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span className="text-[12px] text-acars-text">{airport.timezone}</span>
          </div>
          <div>
