export function RunwaySelector() {
  return (
    <div className="grid grid-cols-5 gap-2 border-b border-acars-border px-3 py-2 text-[12px]">
      <div>
        <span className="data-label">Runway</span>
        <select className="mt-0.5 w-full rounded bg-acars-bg border border-acars-border text-[#dde1e8] text-[12px] tabular-nums px-1 py-0.5">
          <option>12R</option>
        </select>
      </div>
      <div>
