        ...
        <div className="flex h-screen w-screen items-center justify-center bg-acars-bg">
          <div className="max-w-lg text-center space-y-4 p-8">
            ...
            {this.state.componentStack && (
              <pre className="text-left text-[11px] text-acars-muted/70 bg-acars-input border border-acars-border rounded p-3 max-h-48 overflow-auto whitespace-pre-wrap tabular-nums">
                {this.state.componentStack}
              </pre>
            )}
            <button
