    ...
    <div className="flex flex-col h-full overflow-auto">
      <div className="max-w-2xl mx-auto w-full p-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-acars-muted/10 border border-acars-muted/20">
            <Settings className="w-5 h-5 text-acars-muted" />
          </div>
          <div>
