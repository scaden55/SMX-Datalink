    ...
    <div className="rounded-lg border border-[var(--border-primary)] p-3 flex flex-col gap-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-shrink-0 text-center" style={{ width: 48 }}>
          ...
          <span className="text-[8px] text-[var(--text-quaternary)]">covered</span>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex justify-between mt-1">
            <span className="text-[9px] text-[var(--text-quaternary)]">
              {d.coveredDemand.tons}t scheduled
            </span>
            <span className="text-[9px] text-[var(--accent-red)]" style={{ opacity: 0.7 }}>
              {d.uncoveredDemand.tons}t unassigned
            </span>
          </div>
        </div>
        ...
        <div className="flex-shrink-0 text-right">
          ...
          <span className="text-[8px] text-[var(--text-quaternary)]">pending</span>
        </div>
      </div>
