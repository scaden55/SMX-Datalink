  ...
  return (
    <div className={cn('flex items-center justify-between pb-2 mb-3 border-b border-[var(--border-primary)]', className)}>
      <div className="flex items-center gap-2">
        ...
        {count != null && (
          <span className="inline-flex items-center justify-center h-5 min-w-5 px-1.5 rounded-md bg-[var(--accent-blue-bg)] text-[var(--accent-blue)] text-[11px] font-semibold">
            {count}
          </span>
        )}
      </div>
